							...
							return (
								...
								<li key={element.id} className="list-group-item d-flex justify-content-between align-items-start">
									...
									<div className="col-6">
										...
										<div><i class="fa-solid fa-envelope"></i> {element.email}</div>
										<div><i class="fa-solid fa-location-dot"></i> {element.address}</div>
										<div><i class="fa-solid fa-phone-flip"></i> {element.phone}</div>
									</div>
